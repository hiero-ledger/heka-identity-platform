...
export default registerAs('agent', () => {
  ...
  // const networks: INetworkConfig[] = process.env.AGENT_NETWORKS
  //   ? (JSON.parse(process.env.AGENT_NETWORKS) as INetworkConfig[])
  //   : [
  //       {
  //         cosmosPayerSeed: 'soft antenna atom walk coin stage agree primary toward swarm brisk simple',
  //         network: 'testnet',
  //       },
  //     ]
...
{"reqSignature":{"type":"ED25519","values":[{"from":"6WdiPynfLWAp67M9TtX5hR","value":"4BNUD13NrDx2ADAV13kyePTvbC1iJq5YWwAPDg42m1JSGQkJgacAHtdunD22sJKiiRuijhnL5HaYXD5qKgLZ2pfE"},{"from":"MjjBAYk1ef7PGdXAx7zR5J","value":"4hLK4N4esjaMRRgViAfjQ5FWijM5hkLdurmFh6qPTrTvHQhkgjAQw8qzkYHD5QshRKgXtLut3icJtXQ9C7PNrmEk"}]},"txn":{"data":{"data":{"alias":"Node4","services":[]},"dest":"4PS3EDQ3dW1tci1Bp6543CfuuebjFrg36kLAUcskGfaA"},"metadata":{"digest":"9c8e078bab9179d53d236906f9bc500c89dfaba9db628ddebc688e7d8a6b3914","from":"6WdiPynfLWAp67M9TtX5hR","payloadDigest":"c39040f5ca85d04d21419ac895c0eafaa0168095302ecd780d35da46bf9af92b","reqId":1758282424273905271},"protocolVersion":2,"type":"0"},"txnMetadata":{"seqNo":14,"txnTime":1758286183},"ver":"1"}`
  ...
  const networks: [IndyVdrPoolConfig, ...IndyVdrPoolConfig[]] = [
    {
  ...
  // (e.g. to an ngrok URL — see docs/NGROK-DEPLOYMENT.md at the repo root).
  ...
  const didCommConfig: DidCommModuleConfigOptions = {
    endpoints: [httpEndpoint, wsEndpoint],
  }

  const askarStoreConfig: AskarModuleConfigStoreOptions = {
    id: `${label}-wallet-id`,
    key: `${label}-wallet-key`,
    database: {
      type: 'postgres',
      config: {
        host: `${walletPostgresHost}:${walletPostgresPort}`,
      },
      credentials: {
        account: walletPostgresUser,
        password: walletPostgresPass,
      },
    },
  }
  ...
  const credentialsConfiguration: CredentialsConfiguration = {
    ...
    [ProtocolType.Aries]: {
      credentials: [AriesCredentialFormat.AnoncredsW3c, AriesCredentialFormat.AnoncredsIndy],
  ...
  return {
    ...
    indyBesuNodeAddress,
    indyBesuNetwork,
    indyBesuEndorserPrivateKey,
    indyBesuEndorserPublicKey,
    hederaNetwork,
    hederaOperatorId,
    hederaOperatorKey,
